...
class get_model(nn.Module):
    def __init__(self,normal_channel=False):
        ...
        self.sa01 = PointNetSetAbstraction(npoint=4096, radius=0.2, nsample=256, in_channel=6+additional_channel, mlp=[64, 64, 128], group_all=False)
        ...
        # self.sa04 = PointNetSetAbstraction(npoint=2048, radius=0.3, nsample=256, in_channel=6+additional_channel, mlp=[64, 64, 128], group_all=False)
        # self.sa05 = PointNetSetAbstraction(npoint=1024, radius=0.5, nsample=256, in_channel=128 + 3, mlp=[128, 128, 256], group_all=False)
        ...
        # # heatmap2
        # self.sa21 = PointNetSetAbstraction(npoint=1024, radius=0.2, nsample=256, in_channel=256+3, mlp=[64, 64, 128], group_all=False)
        # self.sa22 = PointNetSetAbstraction(npoint=512, radius=0.4, nsample=256, in_channel=128+3, mlp=[128, 128, 256], group_all=False)
        ...
        # # heatmap3
        # self.sa31 = PointNetSetAbstraction(npoint=1024, radius=0.2, nsample=256, in_channel=256+3, mlp=[64, 64, 128], group_all=False)
        # self.sa32 = PointNetSetAbstraction(npoint=512, radius=0.4, nsample=256, in_channel=128+3, mlp=[128, 128, 256], group_all=False)
        ...
        # # heatmap4
        # self.sa41 = PointNetSetAbstraction(npoint=1024, radius=0.2, nsample=256, in_channel=256+3, mlp=[64, 64, 128], group_all=False)
        # self.sa42 = PointNetSetAbstraction(npoint=512, radius=0.4, nsample=256, in_channel=128+3, mlp=[128, 128, 256], group_all=False)
