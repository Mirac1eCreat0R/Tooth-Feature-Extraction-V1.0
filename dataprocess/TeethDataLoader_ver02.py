...
class TeethDataLoader(Dataset):
    def __init__(self, split='train', cache_size=15000):
        # 数据集目录
        self.root = "data_1000/teeth_data_withSeg/" 

        teethFiles = {} #字典
        teethFiles['train'] = [line.rstrip() for line in open('data_1000/teeth_train.txt')] #训练样本
        teethFiles['test'] = [line.rstrip() for line in open('data_1000/teeth_test.txt')] #测试样本
    ...
    def __getitem__(self, index):
        ...
        return point_set, features, segs
...
if __name__ == '__main__':
    ...
    for point,features,seg in DataLoader:
        print(point.shape)
